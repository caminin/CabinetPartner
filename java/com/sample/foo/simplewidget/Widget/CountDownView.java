...
import com.sample.foo.simplewidget.Core.TimerListener;
import com.sample.foo.simplewidget.Core.TimerService;
...
public class CountDownView extends RelativeLayout {
    ...
    public CountDownView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(values.getBoolean(R.styleable.CountDownView_showHour, false)) {
            ...
            //ColorStateList c=getResources().getColorStateList(unitColorId);
            ((TextView) v.findViewById(R.id.hours_unit)).setTextColor(Color.BLACK);
        ...
        if(values.getBoolean(R.styleable.CountDownView_showMin, false)) {
            ...
            //ColorStateList c=getResources().getColorStateList(unitColorId);
            ((TextView) v.findViewById(R.id.minutes_unit)).setTextColor(Color.BLACK);
        ...
        if(values.getBoolean(R.styleable.CountDownView_showSec, false)) {
            ...
            ((TextView) v.findViewById(R.id.seconds_unit)).setTextColor(Color.BLACK);
            mSeconds.setTextColor(Color.BLACK);
        }
        ...
        if(values.getBoolean(R.styleable.CountDownView_showMilli, false)) {
            ...
            //ColorStateList c=getResources().getColorStateList(unitColorId);
            ((TextView) v.findViewById(R.id.milliseconds_unit)).setTextColor(Color.BLACK);
            mMilliseconds.setTextColor(Color.BLACK);
        }
    }
    /**
