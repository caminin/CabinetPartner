...
import com.sample.foo.simplewidget.Adapter.SwipeAdapter;
import com.sample.foo.simplewidget.Libraries.DynamicListView;

/**
 * SwipeMenuListView
 */
public class SwipeMenuListView extends DynamicListView {
    ...
    public void setAdapter(SwipeAdapter adapter) {
        if(mMenuCreator==null){
            Log.v(TAG,"MenuCreator est null");
        }
        adapter.setmMenuCreator(mMenuCreator);
        adapter.setmOnMenuItemClickListener(mOnMenuItemClickListener);
        adapter.setmTouchView(mTouchView);
