...
/**
 * Layout used to show an item of the menu
 */
public class SwipeMenuLayout extends FrameLayout {
    ...
    private int MAX_VELOCITYX = -dp2px(1000);
    ...
    private String TAG="SwipeMenuLayout";
    ...
    public SwipeMenuLayout(View contentView, SwipeMenuView menuView,
        ...
        if(contentView.getVisibility()!=View.VISIBLE){
            Log.v(TAG,"swipe a mis invisible "+contentView.getTag());
            this.setVisibility(View.INVISIBLE);
        }
        this.setTag((String)contentView.getTag());
        init();
    }
